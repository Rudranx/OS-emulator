  ...
  const processStep = (step) => {
    ...
    if (!newFrames.includes(page)) {
      ...
      if (newFrames.includes(null)) {
        ...
        newFrames[randomIndex] = page;
        newFrameIdx = randomIndex;
      }
    }
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white p-10">
      <div className="max-w-5xl mx-auto space-y-10">
        <h1 className="text-3xl font-bold text-blue-400">Random Page Replacement Algorithm</h1>
              ...
              <div
                ...
                className={`p-3 w-20 text-center rounded transition duration-300 ${
                  frame === null
                    ...
                    : idx === newFrameIndex && currentStep >= 0
...
export default RandomPageReplacement;